...
func (*PingMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_ae9d2b328c63950c, []int{0}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_ae9d2b328c63950c) }

var fileDescriptor_api_ae9d2b328c63950c = []byte{
